package pl.altkom.dkah.dogservice.service;
...
import pl.altkom.dkah.dogservice.controller.mapper.RequestMapper;
import pl.altkom.dkah.dogservice.controller.mapper.ResponseMapper;
...
import pl.altkom.dkah.dogservice.repository.DogRepository;
...
public class DogService {
    ...
    public Dog getDog(final Long dogId) {
        final pl.altkom.dkah.dogservice.repository.model.Dog dog = dogRepository
                .findById(dogId)
    ...
    public Dog addDog(final CreateDogRequest request) {
        final pl.altkom.dkah.dogservice.repository.model.Dog savedDog = dogRepository
    ...
    public Dog modifyDog(final Long dogId, final UpdateDogRequest request) {
        ...
        final pl.altkom.dkah.dogservice.repository.model.Dog sourceDog = dogRepository
                .findById(dogId)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));

        final pl.altkom.dkah.dogservice.repository.model.Dog modifiedDog = dogRepository
